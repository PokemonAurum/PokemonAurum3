...
// Counter type indices for btl_scr_cmd_121_SetCondition3Counter
#define CONDITION3_CTR_WINDED    0
#define CONDITION3_CTR_AWESTRUCK 1
#define CONDITION3_CTR_MIGRAINE  2
#define CONDITION3_CTR_IDOLIZE   3
#define CONDITION3_CTR_FATIGUE   4
